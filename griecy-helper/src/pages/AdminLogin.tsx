...
const UserLogin = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (userType !== 'admin') {
        alert(`Access denied. This login is for administrators only. Your account type is: ${userType}`);
        return;
      }
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <div onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center text-sm text-gray-600 mt-6">
                  ...
                  <a href="/admin-signup" className="text-purple-600 hover:underline font-medium">
                    Sign up now
                  </a>
                </div>
              </div>
