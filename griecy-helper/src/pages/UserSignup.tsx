          ...
          <div className="relative bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 px-16 py-12 flex flex-col justify-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="text-white/90 text-xl leading-relaxed font-light max-w-lg">
                Create your account to unlock all features and join our growing community. 
                Experience seamless access to our platform with personalized services tailored just for you.
              </p>
            </div>
          </div>
              ...
              <div onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    value={form.role}
                    onChange={handleChange}
                    className={`w-full pl-14 pr-6 py-4 border-0 rounded-full bg-white appearance-none cursor-pointer transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-sm ${
                      errors.role 
                        ? 'ring-2 ring-red-400 bg-red-50' 
                        : ''
